...
This project is for portfolio demonstration purposes. The dataset is synthetically generated and does not contain real customer or business data.

---

*Created for data analysis portfolio. Questions or feedback welcome!*
